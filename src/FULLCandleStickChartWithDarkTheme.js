...
{/* END BOLLINGER BANDS MODULE */}
{/* START X-AXIS (FOR ALL ELEMENTS) */}
					<XAxis 
						axisAt="bottom" 
						orient="bottom"
						{...xGrid}
...
{/* MOVING AVERAGES END */}
{/* EDGE INDICATOR (last data point) START */}
					<EdgeIndicator 
						itemType="last" 
						orient="right" 
						edgeAt="right"
